...
static Key keys[] = {
  ...
  //─────────────────────────────────/ KEY DEFINITIONS /─────────────────────────────────
    ...
    { MODKEY,                           XK_v,       spawn,          SHCMD("kitty nvim")},
    { MODKEY|ShiftMask,                 XK_Return,  spawn,          {.v = termcmd } },
    { MODKEY,                           XK_w,       spawn,          {.v = browercmd } },
    ...
    { MODKEY|ShiftMask,                 XK_i,       incrigaps,      {.i = +1 } }, // inner gaps
    { MODKEY|ControlMask|ShiftMask,     XK_i,       incrigaps,      {.i = -1 } }, // inner gaps
    { MODKEY|ControlMask,               XK_o,       incrogaps,      {.i = +1 } }, // outer gaps
    { MODKEY|ControlMask|ShiftMask,     XK_o,       incrogaps,      {.i = -1 } }, // outer gaps
