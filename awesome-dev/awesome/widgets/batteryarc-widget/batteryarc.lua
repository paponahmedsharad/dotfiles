...
local function worker(user_args)
  ...
  local font = args.font or 'JetBrains Mono Bold 9'
  ...
  local main_color = args.main_color or "#ffd1e1"
  local bg_color = args.bg_color or '#5d0000'
  local low_level_color = args.low_level_color or '#ff2c00'
  local medium_level_color = args.medium_level_color or '#ffff00'
  local charging_color = args.charging_color or '#00a230'

  local warning_msg_title = args.warning_msg_title or 'Sharad, we have a problem'
  ...
  local function update_widget(widget, stdout)
    ...
    if status == 'Charging' then
      ...
      text_with_background.fg = "#8c9440"
    end
