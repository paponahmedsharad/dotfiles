...
awful.keyboard.append_global_keybindings({
	...
	awful.key({
		...
		description = "reload",
		on_press = function()
			awful.util.spawn_with_shell("eww open-many --toggle background-closer system-menu", false)
		end,
	}),
	...
	awful.key({
		...
		description = "sleep",
		on_press = function()
			awful.util.spawn_with_shell("~/.config/rofi/powermenu/powermenu.sh", false)
	...
	awful.key({
		...
		description = "lock",
		on_press = function()
			awful.util.spawn_with_shell("~/.scripts/lock", false)
			-- awful.util.spawn_with_shell("eww open-many --toggle background-closer powermenu", false)
		end,
	}),
	...
	awful.key({
		...
		on_press = function()
			-- awful.util.spawn_with_shell("~/.config/rofi/powermenu/powermenu.sh", false)
			-- awful.util.spawn_with_shell("eww open-many --toggle background-closer powermenu", false)
			awful.util.spawn_with_shell("systemctl suspend", false)
		end,
	}),
	-- eww dashboard
	awful.key({
		...
		description = "reload",
		on_press = function()
			awful.util.spawn_with_shell("~/.config/eww/dashboard/launch_dashboard", false)
		end,
	}),
	...
	awful.key({
		...
		on_press = function()
			-- awful.spawn(editor)
			-- awful.util.spawn_with_shell("neovide -- -c 'Telescope oldfiles'")
			-- awful.util.spawn_with_shell("neovide -- -c 'FzfLua oldfiles'")
			-- awful.util.spawn_with_shell("neovide --multigrid -- -c 'FzfLua'")
			awful.util.spawn_with_shell("neovide --multigrid")
		end,
	}),
})
...
awful.keyboard.append_global_keybindings({
	...
	awful.key({
		...
		on_press = function()
			awful.util.spawn_with_shell(
				"amixer -q -D pulse sset Master 5%+ && /home/sharad/.config/eww/Misc/scripts/volume",
				false
			)
	...
	awful.key({
		...
		on_press = function()
			...
			awful.util.spawn_with_shell("brightnessctl set 1%+ && $HOME/.config/eww/Misc/scripts/brightness", false)
		end,
	}),
	...
	awful.key({
		...
		on_press = function()
			awful.util.spawn("scrot 'Sharad-%Y-%m-%d-%s_screenshot_$wx$h.jpg' -e 'mv $f $$(xdg-user-dir PICTURES)'")
	...
	-- awful.key
	{
		...
		on_press = function()
			...
			awful.util.spawn_with_shell("/home/sharad/.config/rofi/powermenu/powermenu.sh", false)
		end,
	},
...
awful.keyboard.append_global_keybindings({
	...
	awful.key({
		...
		on_press = function()
			-- power_popup:show()
			awful.util.spawn_with_shell("~/.config/picom/picom-toggle.sh")
		end,
	}),
